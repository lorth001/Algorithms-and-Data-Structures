/*
* File name: bagtestmain.cpp -- This file is used to test the bag and dictionary implementations in addition to the ADTs that were provided
* CSIS 215-B01
* References: Most of this code remains in its original state, as provided by Liberty University for use in this assignment
*/
...
int main(int argc, char** argv) {
	...
	cout << "Luke Orth -- CSIS 215 Programming Assignment 1 -- Bag Dictionary" << endl << endl;
